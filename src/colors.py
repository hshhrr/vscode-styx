...
class BaseColors:
    # Background
    bg0: str = "#000000"                #   HSV -> 0°, 0%, 0%
    bg1: str = "#101112"                #   HSV -> 225°, 10%, 7%
    bg2: str = get_shade(bg1, 10, 14)
    
    # Foreground
    fg0: str = "#C2C5CC"                #   HSV -> 225°, 5%, 80%
